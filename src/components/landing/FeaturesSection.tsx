...
export function FeaturesSection() {
  ...
  return (
    <section id="funcionalidades" aria-label="Funcionalidades do sistema de precificação" className="py-16 md:py-24 bg-muted/30">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Da tabela de preços ao controle financeiro — tudo que sua confeitaria precisa para crescer com lucro
          </p>
        </div>
