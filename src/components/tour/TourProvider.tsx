...
const tourSteps: StepType[] = [
  {
    ...
    content: (
      <div className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground">O fluxo é: Ingredientes → Receitas → Produtos</p>
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground">Clique em qualquer card para acessar a lista completa.</p>
      </div>
    ),
  },
  {
  ...
  },
  {
    ...
    content: (
      <div className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground">Ex: Farinha de trigo - R$ 25,00 por 5kg</p>
        <p className="text-sm text-muted-foreground">O sistema calcula automaticamente o custo por grama!</p>
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground">O sistema soma o custo de cada ingrediente e calcula o custo total da receita!</p>
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground">Defina a margem de lucro e veja o preço de venda sugerido!</p>
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground">Funciona igual aos ingredientes: preço da embalagem ÷ quantidade.</p>
      </div>
    ),
  },
  {
  ...
  },
  {
    ...
    content: (
      <div className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground">Você pode acessar este tour novamente clicando no botão "Tour Guiado" no Dashboard.</p>
      </div>
    ),
  },
];
